...
function argsToOptions(args)
{
	...
	return Object.keys(args).reduce( function(opts, arg)
	{
		if (arg in renames)
		{
...
function cli(args=process.argv)
{
	...
	verbosity += "  0: broken links\n";
	verbosity += "  1: 0 + unbroken links\n";
	verbosity += "  2: 1 + skipped links";
...
function run()
{
	Object.keys(gaugeThemes).forEach( function(theme)
	{
	...
	if (supportsSemigraphics())
	{
		...
		keyScanner = scanKeys( function(key)
		{
			if (key.parsed === "space")
			{
				togglePause();
